...
// Stryker disable all: import.meta.glob exige argumentos estáticos — Vite
// los analiza en tiempo de build, no en tiempo de ejecución — así que
// mutar el patrón o las opciones rompe el parseo y no un test.
